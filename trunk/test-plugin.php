 ...
 * @author Keith Huster
 */
class TestPlugin extends TestPlugin_WordpressPluginFramework
{
   // ---------------------------------------------------------------------------
...
if( !$myTestPlugin  )
{
  ...
  $myTestPlugin->AddOption( $myTestPlugin->OPTION_TYPE_CHECKBOX, 'myCheckboxOption', $myTestPlugin->CHECKBOX_UNCHECKED, 'Simple checkbox option for your plugin.' );
  $myTestPlugin->AddOption( $myTestPlugin->OPTION_TYPE_RADIOBUTTONS, 'myRadiobuttonOption', 'Value 1', 'Simple radiobutton option for your plugin.,Value 1,Value 2,Value 3' );
  $myTestPlugin->AddOption( $myTestPlugin->OPTION_TYPE_TEXTAREA, 'myTextareaOption', 'Hello! This is an example of a multiline text area.', 'Simple textarea option for your plugin.' );
  $myTestPlugin->AddOption( $myTestPlugin->OPTION_TYPE_PASSWORDBOX, 'myPasswordboxOption', 'password', 'Simple passwordbox option for your plugin.' );
  $myTestPlugin->AddOption( $myTestPlugin->OPTION_TYPE_COMBOBOX, 'myComboboxOption', 'Combo 1', 'Simple combobox option for your plugin.,Combo 1,Combo 2,Combo 3,Combo 4,Combo 5' );
  ...
  //
  $myTestPlugin->AddAdministrationPageBlock( 'block-description', 'Plugin Description', $myTestPlugin->CONTENT_BLOCK_TYPE_MAIN, array($myTestPlugin, 'HTML_DisplayPluginDescriptionBlock') );
  $myTestPlugin->AddAdministrationPageBlock( 'block-options-displayed', 'Plugin Options Displayed', $myTestPlugin->CONTENT_BLOCK_TYPE_MAIN, array($myTestPlugin, 'HTML_DisplayPluginOptionsDisplayedBlock') );
  $myTestPlugin->AddAdministrationPageBlock( 'block-options-listed', 'Plugin Options Listed', $myTestPlugin->CONTENT_BLOCK_TYPE_MAIN, array($myTestPlugin, 'HTML_DisplayPluginOptionsListedBlock') );
  ...
  $myTestPlugin->AddAdministrationPageBlock( 'block-hello-again', 'Hello Again', $myTestPlugin->CONTENT_BLOCK_TYPE_SIDEBAR, array($myTestPlugin, 'HTML_DisplayPluginHelloAgainBlock') );
